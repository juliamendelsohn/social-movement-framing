...
baseoutdir="/nfs/turbo/si-juliame/social-movements/roberta_models/${modelname}/${frametype}_${date}"
...
#             do
#             trainfile="${trainfilebase}/fold_${fold}/train_relevant_${movement}_${stance}.tsv"
#             outdir="${outbase}/fold_${fold}/${movement}_${stance}/"
#             categories=${categories}
#             mkdir -p ${outdir}
#             python train_roberta.py \
#             --train-file=${trainfile} \
